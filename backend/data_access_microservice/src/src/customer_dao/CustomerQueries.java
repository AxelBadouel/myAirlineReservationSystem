...
class CustomerQueries {
    public static final String INSERT_CUSTOMER = "INSERT INTO customer_data (customer_name, city_departure, city_destination, datetime_of_flight, booking_status, ticket_cost, email, flight_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
