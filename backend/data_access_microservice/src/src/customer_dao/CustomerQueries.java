...
class CustomerQueries {
    ...
    public static final String UPDATE = "UPDATE customer_data SET customer_name=?, city_departure=?, city_destination=?, datetime_of_flight=?, booking_status=?, ticket_cost=?, email=? WHERE username=?";
